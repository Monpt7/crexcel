...
module Crexcel
  ...
  class ArchiveBuilder
    getter dirs : Crexcel::Workbook::Dirs

    def initialize(@dirs, nbr_sheets : Int32)
      string = XML.build(encoding: "UTF-8") do |xml|
        xml.element("Types", xmlns: "http://schemas.openxmlformats.org/package/2006/content-types") do
          ...
          (1..nbr_sheets).each do |nbr|
            xml.element("Override", "PartName": "/xl/worksheets/sheet#{nbr}.xml", "ContentType": "application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml")
          end
      ...
      File.write(File.join(dirs[:root], "[Content_Types].xml"), string)
      init_theme
      init_style
      init_app
      init_core
    ...
    private def init_theme
      ...
      XML
      File.write(File.join(dirs[:xl_theme], "theme1.xml"), xmlstr)
    end

    private def init_style
      xmlstr = <<-XML
      <?xml version="1.0" encoding="UTF-8" standalone="yes"?>
      ...
      XML
      File.write(File.join(dirs[:xl], "styles.xml"), xmlstr)
    end
    ...
    private def init_app
      ...
      XML
      File.write(File.join(dirs[:doc_props], "app.xml"), xmlstr)
    end

    private def init_core
      xmlstr = <<-XML
      <?xml version="1.0" encoding="UTF-8" standalone="yes"?>
      <cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><dc:creator></dc:creator><cp:lastModifiedBy></cp:lastModifiedBy><dcterms:created xsi:type="dcterms:W3CDTF">2018-03-21T09:37:01Z</dcterms:created><dcterms:modified xsi:type="dcterms:W3CDTF">2018-03-21T09:37:01Z</dcterms:modified></cp:coreProperties>
      XML
      File.write(File.join(dirs[:doc_props], "core.xml"), xmlstr)
    end

    private def init_rels
      xmlstr = <<-XML
      <?xml version="1.0" encoding="UTF-8" standalone="yes"?>
      <Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/><Relationship Id="rId2" Type="http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties" Target="docProps/core.xml"/><Relationship Id="rId3" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties" Target="docProps/app.xml"/></Relationships>
      XML
      File.write(File.join(dirs[:rels], ".rels"), xmlstr)
    end
  end
end

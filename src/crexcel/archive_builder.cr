module Crexcel
  ...
  class ArchiveBuilder
    ...
    def initialize(location : String, nbr_sheets : Int32)
      @rootdir = location+'/'
      ...
      File.write(@rootdir+"[Content_Types].xml",string)
      init_theme
      init_style
      init_app
      init_core
    ...
    private def init_theme
      ...
      XML
      File.write(@rootdir+"xl/theme/theme1.xml",xmlstr)
    end
    ...
    private def init_style
      ...
      XML
      File.write(@rootdir+"xl/styles.xml",xmlstr)
    end
    ...
    private def init_app
      ...
      XML
      File.write(@rootdir+"docProps/app.xml",xmlstr)
    end
    ...
    private def init_core
      ...
      XML
      File.write(@rootdir+"docProps/core.xml",xmlstr)
    end
    ...
    private def init_rels
      ...
      XML
      File.write(@rootdir+"_rels/.rels",xmlstr)
    end
